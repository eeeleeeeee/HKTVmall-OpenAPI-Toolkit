...
Base URL for all Store APIs: `https://merchant-oapi.shoalter.com`
...
**GET** `https://merchant-oapi.shoalter.com/oapi/api/store/details`
Version: v2.0.0
  ...
  "data": [
    {
      ...
      "storeNameZh": "ZH",
      "storeNameZh": "ZHCN",
      "merchantNameEn": "example_merchant",
      "merchantNameZh": "example_merchant",
      "deliveryThreshold": 2,
      "deliveryFee": 3
    }
  ],
...
**POST** `https://merchant-oapi.shoalter.com/oapi/api/store`
Version: v2.0.0
